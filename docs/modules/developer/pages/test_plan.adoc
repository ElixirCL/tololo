...
http://example.com/deliveries/new (The domain should be changed to the one where Eatsbot is hosted in)
...
- The delivery person should send a message to the Eatsbot Telegram bot. The content of the message can be anything.
- An access request will be sent to Eatsbot, then an admin will have to approve the user through the admin dashboard. The admin dashboard is in the following page: http://example.com/admin
