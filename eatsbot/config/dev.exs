...
config :eatsbot, EatsbotWeb.Endpoint,
  ...
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:eatsbot, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:eatsbot, ~w(--watch)]}
  ]

config :eatsbot,
  extensions: read_config(:eatsbot)[:extensions] ++ [Eatsbot.Extensions.Kafka],
  token_signing_secret: "U635EKPRXu35QYRpGZEZVN93UasSAl3t"

config :eatsbot, Eatsbot.Extensions.Prometheus.PromEx,
  disabled: false,
...
config :eatsbot, EatsbotWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/eatsbot_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :eatsbot, dev_routes: true, token_signing_secret: "+1VVhrzkFzEh5GtKKHbhsf/uxlQsUZmS"
