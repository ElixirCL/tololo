...
config :eatsbot, Eatsbot.Repo,
  ...
  password: "postgres",
  hostname: "localhost",
  database: "eatsbot_test#{System.get_env("MIX_TEST_PARTITION")}",
...
config :eatsbot, Eatsbot.Mailer, adapter: Swoosh.Adapters.Test
...
config :eatsbot, Eatsbot.Prometheus, disabled: true
