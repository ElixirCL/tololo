defmodule EatsbotCore.Extension do
  @moduledoc """
  ...
  @extensions Application.compile_env(:eatsbot, :extensions)

  defmacro __using__([]) do
    quote do
      @behaviour EatsbotCore.Extension

      @before_compile EatsbotCore.Extension
    end
  end
