defmodule EatsbotWeb.DeliveryLive.LocationInputComponent do
  ...
  def render(assigns) do
    ...
    <div>
      ...
      <.input
        readonly
        placeholder={gettext("Found address will show up here")}
        field={@address_field}
      />
  ...
  def handle_event(
    ...
    socket =
      if value != "",
        do:
          socket
          |> put_location_assigns(Eatsbot.Geocoding.query(value))
