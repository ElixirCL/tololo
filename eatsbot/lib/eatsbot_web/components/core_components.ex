defmodule EatsbotWeb.CoreComponents do
  @moduledoc """
    ...
    <div>
      ...
      <input
        ...
        class={[
          ...
          @errors == [] &&
            "border-zinc-300 focus:border-zinc-400 read-only:border-zinc-100 read-only:bg-zinc-50",
          @errors != [] && "border-rose-400 focus:border-rose-400"
        ]}
        {@rest}
      />
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(Eatsbot.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(Eatsbot.Gettext, "errors", msg, opts)
    end
  end
