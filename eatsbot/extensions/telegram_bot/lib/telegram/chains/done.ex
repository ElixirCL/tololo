defmodule Eatsbot.Extensions.TelegramBot.Done do
  @moduledoc false
  ...
  alias Eatsbot.Extensions.TelegramBot.Message
  ...
  defp get_current_to_distance(%{
       ...
       do: EatsbotCore.Location.distance({current_lat, current_lng}, {to_lat, to_lng})
end
