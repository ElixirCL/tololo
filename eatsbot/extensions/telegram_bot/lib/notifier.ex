defmodule Eatsbot.Extensions.TelegramBot.Notifier do
  use GenServer
  ...
  @impl true
  def init(_) do
    pubsub = Application.fetch_env!(:eatsbot, :pubsub)
  ...
  def handle_info(
    ...
    Eatsbot.Extensions.TelegramBot.Ash.User.get_available_users!()
