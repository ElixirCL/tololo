...
_Cerro Eatsbot_, whose name means "`on the edge of the abyss,`" a
...
- https://en.wikipedia.org/wiki/Cerro_Eatsbot_Inter-American_Observatory[Wikipedia]
...
*Eatsbot* is a set of _Elixir_ components that bring functionality akin
...
[IMPORTANT] 
====
Eatsbot is mainly targeted to Chilean’s market needs.
====

== Features

Eatsbot E-commerce is mainly inspired by
...
- *API*: Power your storefront or mobile app via _Eatsbot’s_ API.
